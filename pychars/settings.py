"""
Django settings for pychars project.
...
SECRET_KEY = 'ne+%g_0ep&76j_$##1tf6kz(r7#gz8_1i7v1+pw3d5n460-5@v'
...
WSGI_APPLICATION = 'pychars.wsgi.application'
